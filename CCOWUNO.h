...
#ifndef ONEWIRE_CCOWUNO_H
#define ONEWIRE_CCOWUNO_H

#include "OneWireItem.h"

class CCOWUNO : public OneWireItem
{
private:
...
public:
    ...
    static constexpr uint8_t family_code        { 0xCC };

    CCOWUNO(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6, uint8_t ID7);
